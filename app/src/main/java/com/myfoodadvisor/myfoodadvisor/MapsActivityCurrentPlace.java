...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    private LatLng[] mLiwaikelyPlaceLatLngs;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_accueil) {
                    Intent i = new Intent(MapsActivityCurrentPlace.this, Acceuil.class);
                    startActivity(i);
                    ...
                    Intent i = new Intent(MapsActivityCurrentPlace.this, mon_profil.class);
                    startActivity(i);
                    finish();
                    ...
                    (new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                        ...
                        public void onComplete(@NonNull Task<PlaceLikelihoodBufferResponse> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                mLiwaikelyPlaceLatLngs = new LatLng[count];
                                ...
                                for (PlaceLikelihood placeLikelihood : likelyPlaces) {
                                    ...
                                    mLikelyPlaceAttributions[i] = (String) placeLikelihood.getPlace()
                                            .getAttributions();
                                    mLiwaikelyPlaceLatLngs[i] = placeLikelihood.getPlace().getLatLng();
    ...
    /*private void openPlacesDialog() {
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                LatLng markerLatLng = mLiwaikelyPlaceLatLngs[which];
