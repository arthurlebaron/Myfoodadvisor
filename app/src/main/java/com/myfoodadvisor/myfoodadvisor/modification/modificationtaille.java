...
public class modificationtaille extends Activity implements View.OnClickListener{
            ...
            mRef.child("users").child(username).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getValue() != null){
                        ...
                        String taille = valeur.getText().toString();
                        ...
                        mRef.child("users").updateChildren(update).addOnCompleteListener(modificationtaille.this, new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(modificationtaille.this, "Erreur dans la modification.",
